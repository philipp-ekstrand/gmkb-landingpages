<?php
/**
 * Template Name: Karriere – Ergotherapie
 *
 * Custom Page Template fuer die Ergotherapie-Landingpage auf karriere.medizinundtherapie.de.
...
<head>
  ...
  <!-- SEO Meta Tags -->
  <title>Ergotherapeut (m/w/d) – Stellenanzeige Ergotherapeut Köln/Bonn | GMKB Karriere</title>
  <meta name="description" content="Ergotherapeut gesucht in Köln und Bonn! Stellenangebote Ergotherapie: unbefristet, tarifliches Gehalt, 31 Tage Urlaub, Weiterbildungsmöglichkeiten für Ergotherapeuten. Jetzt in 60 Sekunden bewerben. Auch Quereinstieg Ergotherapie möglich.">
  <!-- TODO: Nach Live-Schaltung wieder auf "index, follow" setzen -->
  <meta name="robots" content="noindex, nofollow">
  <link rel="canonical" href="https://karriere.medizinundtherapie.de/ergotherapeut-ergotherapeutin/">

  <!-- Open Graph -->
  <meta property="og:type" content="website">
  <meta property="og:title" content="Ergotherapeut (m/w/d) – Stellenanzeige Ergotherapeut Köln/Bonn | GMKB Karriere">
  <meta property="og:description" content="Ergotherapie Jobs in Köln und Bonn: unbefristet, tarifliches Gehalt, Fortbildungen für Ergotherapeuten, Kita-Platz. Job als Ergotherapeut – bewirb dich in 60 Sekunden.">
  <meta property="og:url" content="https://karriere.medizinundtherapie.de/ergotherapeut-ergotherapeutin/">
  ...
  <!-- Preload Hero Image -->
  <link rel="preload" as="image" type="image/webp" imagesrcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-960w.webp 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-1440w.webp 1440w" imagesizes="(max-width: 900px) 100vw, 55vw">
  ...
  <script type="application/ld+json">
  {
    ...
    "description": "Ergotherapeut gesucht: unbefristete Stelle als Ergotherapeut oder Ergotherapeutin in Voll- oder Teilzeit im Raum Köln/Bonn. Tarifliches Gehalt (ca. 48.800 – 57.300 EUR Jahresbrutto), 31 Tage Urlaub, Weiterbildung für Ergotherapeuten, Kita-Platz-Vermittlung, interdisziplinäre Zusammenarbeit in der Ergotherapie.",
    ...
    "jobBenefits": "Unbefristete Anstellung, Tarifliches Gehalt, 31 Tage Urlaub + Heiligabend & Silvester frei, Kita-Platz-Vermittlung, Fortbildungen Ergotherapie, Weiterbildung zur Ergotherapeutin, Deutschlandticket, Corporate Benefits, Interdisziplinäre Zusammenarbeit",
    "qualifications": "Staatlich anerkannter Ergotherapeut oder Ergotherapeutin",
...
<body>
  ...
  <!-- ============================================================
       [1] HERO SECTION
       ============================================================ -->
  <section class="hero-v2" aria-label="Stellenangebot Ergotherapeut – Ergotherapie Jobs Köln/Bonn">
    ...
    <div class="container">
     <div class="hero-v2__card">
      <div class="hero-v2__content">
        <p class="hero-v2__eyebrow">Stellenangebot Ergotherapeut – GMKB Medizinzentren Köln/Bonn</p>

        <h1 class="hero-v2__title">
          <span class="hero-v2__title-accent">Ergotherapeut / Ergotherapeutin gesucht</span>
        </h1>
        ...
        <p class="hero-v2__hook">Du bist auf Jobsuche als Ergotherapeut in der Kinder- und Jugendtherapie im Raum Köln/Bonn? Dann bist du bei uns genau richtig.</p>

        <div class="hero-v2__actions">
          <a href="#bewerbung" class="btn btn--flip" data-track="cta-click" data-track-label="hero-cta">
      ...
      <div class="hero-v2__visual">
        <picture>
          <source type="image/webp" srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-960w.webp 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-1440w.webp 1440w" sizes="(max-width: 900px) 100vw, 50vw">
          <img src="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-960w.jpg" srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-960w.jpg 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-1440w.jpg 1440w" sizes="(max-width: 900px) 100vw, 50vw" alt="Ergotherapeut bei der Bewegungstherapie mit einem Kind im GMKB Medizinzentrum" width="960" height="1440" class="hero-v2__img">
        </picture>
      </div>
     </div>
  ...
  <!-- ============================================================
       [2] BENEFITS SECTION – "Unser Versprechen an Dich"
       ============================================================ -->
  <section class="benefits section" id="benefits" aria-labelledby="benefits-heading">
    <div class="container">
      <div class="benefits__header reveal">
        ...
        <h2 id="benefits-heading">Deine Vorteile als Ergotherapeut in Köln/Bonn bei der GMKB</h2>
        <p class="benefits__intro">Wir bieten dir als Ergotherapeut nicht nur einen Job, sondern ein Umfeld, in dem du Kinder in Motorik, Wahrnehmung und Alltagskompetenz ganzheitlich fördern kannst.</p>
      </div>
      ...
      <div class="benefits__grid reveal-stagger">
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Unbefristete Stelle als Ergotherapeut bei einem seit über 20 Jahren etablierten gemeinnützigen Träger im Raum Köln/Bonn.</p>
          </div>
        </article>

        <!-- Card 2: Attraktive Vergütung -->
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            <div class="benefit-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <h3 class="benefit-card__title">Attraktive Vergütung</h3>
            <p class="benefit-card__text">Tarifliches Gehalt (ca. 48.800 – 57.300 EUR Jahresbrutto in Vollzeit inkl. Jahressonderzahlung), zzgl. Kinderzuschlag, VL, Altersvorsorge und Mobilitätszuschuss.</p>
          </div>
        </article>
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Kita-Plätze in Bonn &amp; Rhein-Sieg-Kreis, flexible Arbeitszeiten, auch in Teilzeit möglich.</p>
          </div>
        </article>

        <!-- Card 4: Weiterbildung für Ergotherapeuten -->
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            <div class="benefit-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <h3 class="benefit-card__title">Weiterbildung für Ergotherapeuten</h3>
            <p class="benefit-card__text">Kostenübernahme &amp; Freistellung für Pflichtfortbildungen sowie vielfältige Weiterbildungsmöglichkeiten für Ergotherapeuten in Pädiatrie und Frühförderung.</p>
          </div>
        </article>

        <!-- Card 5: 31 Tage Urlaub -->
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            <div class="benefit-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <h3 class="benefit-card__title">31 Tage Urlaub + Heiligabend &amp; Silvester frei</h3>
            <p class="benefit-card__text">Mehr Erholung bei einer 5-Tage-Woche. Damit du auch außerhalb der Arbeit genügend Zeit für dich und deine Familie hast.</p>
          </div>
        </article>
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Exklusive Mitarbeiterrabatte bei vielen Partnern &amp; monatlicher, steuerfreier Zuschuss für dein Deutschlandticket.</p>
          </div>
        </article>

        <!-- Card 7: Interdisziplinäre Zusammenarbeit -->
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            <div class="benefit-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <h3 class="benefit-card__title">Interdisziplinäre Zusammenarbeit</h3>
            <p class="benefit-card__text">Eng verzahnt mit Kinderärzten, Logopäden und Pädagogen für die ganzheitliche Förderung von Kindern.</p>
          </div>
        </article>
      </div>

      <div class="benefits__cta reveal">
        <a href="#bewerbung" class="btn btn--flip" data-track="cta-click" data-track-label="benefits-cta">
          <span class="btn__texts">
            <span class="btn__text">Jetzt als Ergotherapeut bewerben</span>
            <span class="btn__text">Jetzt als Ergotherapeut bewerben</span>
          </span>
          <span class="btn__arrows">
            <svg class="btn__arrow-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
  ...
  <!-- ============================================================
       [3] AUFGABEN & PROFIL SECTION
       ============================================================ -->
  <section class="aufgaben-profil section" id="aufgaben" aria-labelledby="aufgaben-heading">
    <div class="container">
      <div class="aufgaben__header reveal">
        <span class="benefits__tag">
          <span class="benefits__tag-dot"></span>
          Stelle als Ergotherapeut
        </span>
      ...
      <div class="aufgaben__grid">
        <div class="aufgaben__col reveal">
          ...
          <ul class="aufgaben__list">
            <li>Durchführung ergotherapeutischer Befundung und Behandlung bei Kindern und Jugendlichen</li>
            <li>Förderung von Motorik, Wahrnehmung und Handlungsfähigkeit im Alltag</li>
            <li>Erstellen individueller Therapiepläne und Dokumentation</li>
            <li>Interdisziplinäre Zusammenarbeit mit Kinderärzten, Logopäden und Pädagogen</li>
          </ul>
        </div>
        <div class="aufgaben__col reveal">
          <h3 class="aufgaben__title">Dein Profil</h3>
          <ul class="aufgaben__list">
            <li>Abgeschlossene Ausbildung als Ergotherapeut oder Ergotherapeutin</li>
            <li>Freude an der Arbeit mit Kindern und Jugendlichen</li>
            <li>Teamgeist und Lust auf interdisziplinäre Zusammenarbeit</li>
            <li>Auch Berufseinsteiger und Quereinsteiger willkommen</li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <!-- ============================================================
       [6] TESTIMONIAL SECTION – Felix (Ergotherapeut)
       ============================================================ -->
  <section class="testimonial section" aria-labelledby="testimonial-heading">
    <div class="container">
      <div class="testimonial__header reveal">
        ...
        <h2 id="testimonial-heading">So erleben Ergotherapeuten<br>die Arbeit bei der GMKB</h2>
      </div>
        ...
        <div class="testimonial__card reveal">
          <div class="testimonial__quote-col">
            <figure class="testimonial__quote">
              ...
              <blockquote>
                <p>"Ein wichtiger und schöner Teil im Arbeitsalltag ist vor allem auch der Austausch mit dem ganzen Team!"</p>
              </blockquote>
              <figcaption>
                <strong class="testimonial__name">Felix</strong>
                <span class="testimonial__role">Frühförderung / Ergotherapie</span>
              </figcaption>
            </figure>
          </div>
          <div class="testimonial__image-col">
            <img src="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-bewegung-960w.jpg" alt="Felix, Ergotherapeut in der Frühförderung bei der GMKB" loading="lazy" width="960" height="1440">
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- ============================================================
       [8] ABLAUF SECTION – "So einfach geht's"
       ============================================================ -->
  <section class="process section" id="ablauf" aria-labelledby="process-heading">
    <div class="container">
      <div class="process__header reveal">
        ...
        <h2 id="process-heading">Bewerbung als Ergotherapeut<br>so einfach geht's</h2>
        <p class="process__intro">Deine Jobsuche Ergotherapeut endet hier – drei einfache Schritte zu deiner neuen Stelle im Raum Köln/Bonn bei der GMKB.</p>
      </div>
  ...
  <section class="form-section section" id="bewerbung" aria-labelledby="form-heading">
    <div class="container container--narrow">
      <div class="form-section__header reveal">
        ...
        <h2 id="form-heading">Jetzt als Ergotherapeut<br>bewerben</h2>
        <p class="form-section__intro">Deine Bewerbung als Ergotherapeut dauert nur 60 Sekunden – kein Lebenslauf nötig. Wir melden uns innerhalb von 72 Stunden.</p>
      </div>

      <div class="form-card reveal">
        <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" class="form" id="bewerbung-form" novalidate enctype="multipart/form-data" data-track="form-submit" data-track-label="bewerbung-ergotherapie">

          <input type="hidden" name="action" value="gmkb_bewerbung_ergotherapie">
          <input type="hidden" name="csrf_token" value="<?php echo esc_attr( $_SESSION['csrf_token'] ); ?>" id="csrf-token">
          <input type="hidden" name="berufsfeld" value="ergotherapeut">
          ...
          <div class="form-steps">
            <div class="form-steps__track" id="form-track">
              ...
              <div class="form-steps__step" data-step="0">
                <p class="form-step__question">Hast du eine abgeschlossene Ausbildung als Ergotherapeut oder Ergotherapeutin?</p>
                <div class="form-step__choices">
                  <button type="button" class="form-step__choice" data-value="ja" data-next="1">Ja</button>
                  <button type="button" class="form-step__choice" data-value="nein" data-next="reject">Nein</button>
                </div>
              </div>
              ...
              <div class="form-steps__step" data-step="reject">
                <div class="form-step__reject">
                  ...
                  <p class="form-step__reject-title">Für diese Stelle setzen wir eine abgeschlossene Ausbildung als Ergotherapeut oder Ergotherapeutin voraus.</p>
  ...
  <!-- ============================================================
       [4] FEATURE SECTION – Interdisziplinäres Arbeiten
       ============================================================ -->
    ...
    <div class="container feature__container">
      <div class="feature__image reveal">
        <picture>
          <source
            type="image/webp"
            srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-960w.webp 960w"
            sizes="(max-width: 900px) 100vw, 50vw"
          >
          <img
            src="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-960w.jpg"
            srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-960w.jpg 960w"
            sizes="(max-width: 900px) 100vw, 50vw"
            alt="Ergotherapeut hilft Kind beim Balancieren im GMKB Medizinzentrum"
            width="960"
            height="2148"
            loading="lazy"
          >
      ...
      <div class="feature__content reveal">
        ...
        <p>Die GMKB ist ein gemeinnütziger Träger mit über 20 Jahren Erfahrung in der Kinder- und Jugendmedizin. An 12 Standorten in Köln und Bonn arbeiten Ergotherapeuten, Kinderärzte, Logopäden und Pädagogen interdisziplinär zusammen – für eine ganzheitliche Versorgung, die Kindern wirklich hilft.</p>
  ...
  <section class="video section" id="video" aria-labelledby="video-heading">
    <div class="container">
      <div class="video__header reveal">
        ...
        <h2 id="video-heading">Lerne dein Team kennen</h2>
        <p class="video__intro">Unsere Ergotherapeuten und das gesamte Team erzählen, warum die GMKB Medizinzentren in Köln und Bonn ein besonderer Arbeitsplatz sind.</p>
      </div>
        ...
        <div class="video__frame">
          <picture>
            ...
            <img
              ...
              srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-balance-960w.jpg 960w"
              sizes="(max-width: 768px) 100vw, 80vw"
              alt="Ergotherapeut hilft Kind beim Balancieren im GMKB Medizinzentrum Köln/Bonn"
              width="960"
              height="2148"
              loading="lazy"
              class="video__poster"
      ...
      <section class="cta-banner" aria-label="Jetzt bewerben">
        ...
        <div class="cta-banner__inner">
          <div class="cta-banner__container">
            ...
            <p class="cta-banner__subtext">Bewirb dich jetzt in 60 Sekunden, ganz ohne Lebenslauf.</p>
          ...
          <figure class="cta-banner__figure" aria-hidden="true">
            <img src="<?php echo $gmkb_assets; ?>/images/cta-ergotherapeut.png" alt="" width="280" height="400" loading="lazy">
          </figure>
        </div>
      </section>
    </div>
  ...
  <section class="form-section section" id="bewerbung-2" aria-labelledby="form-heading-2">
    <div class="container container--narrow">
      <div class="form-section__header reveal">
        ...
        <h2 id="form-heading-2">Jetzt als Ergotherapeut<br>bewerben</h2>
        <p class="form-section__intro">Deine Bewerbung als Ergotherapeut dauert nur 60 Sekunden – kein Lebenslauf nötig. Wir melden uns innerhalb von 72 Stunden.</p>
      </div>

      <div class="form-card reveal">
        <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" class="form" id="bewerbung-form-2" novalidate enctype="multipart/form-data" data-track="form-submit" data-track-label="bewerbung-ergotherapie">
  ...
  <section class="faq section" id="faq" aria-labelledby="faq-heading">
    <div class="container">
      <div class="faq__header reveal">
        ...
        <h2 id="faq-heading">Häufige Fragen zur<br>Ergotherapeut Stelle bei der GMKB</h2>
        <p class="faq__intro">Alles Wichtige rund um Jobs Ergotherapie, Stellen Ergotherapie und deine Bewerbung bei der GMKB im Raum Köln/Bonn.</p>
      </div>
      ...
      <div class="faq__grid">
        <div class="faq__col">
          ...
          <div class="faq__item reveal">
            ...
            <div class="faq__answer">
              <p>Absolut! Die Arbeitszeiten als Ergotherapeut sind bei uns flexibel gestaltbar – sowohl Vollzeit als auch Teilzeit. Sprich uns einfach an.</p>
            </div>
          </div>
        ...
        <div class="faq__col">
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Welche Fortbildungen gibt es für Ergotherapeuten?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Umfangreiche Fortbildung Ergotherapie Pädiatrie und fachübergreifende Weiterbildung für Ergotherapeuten und Ergotherapeutinnen – auch Weiterbildung zur Ergotherapeutin in spezialisierten Bereichen. Von Sensorischer Integration bis Frühförderung, Kostenübernahme und Freistellung inklusive.</p>
            </div>
          </div>
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Wie ist das Gehalt als Ergotherapeut strukturiert?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Wir vergüten nach Tarif mit regelmäßigen Gehaltsanpassungen. Je nach Erfahrungsstufe liegt das Jahresbruttogehalt derzeit bei ca. 48.800 – 57.300 EUR in Vollzeit (inkl. Jahressonderzahlung). Dazu kommen Kinderzuschlag, VL, Altersvorsorge, ein Mobilitätszuschuss (z.&thinsp;B. Deutschlandticket) und weitere Corporate Benefits.</p>
            </div>
          </div>
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Wo genau sind die Stellen für Ergotherapeuten?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Im Raum Köln/Bonn – Stellenangebote Ergotherapie in der Nähe von beiden Städten. Unsere Ergotherapie Stellenanzeigen umfassen Standorte in Bonn, im Rhein-Sieg-Kreis und im Großraum Köln, gut erreichbar mit öffentlichen Verkehrsmitteln. Ergotherapeuten gesucht sowohl in Köln als auch in Bonn.</p>
            </div>
          </div>
          ...
          <div class="faq__item reveal">
            ...
            <div class="faq__answer">
              <p>Ja! Wir vermitteln aktiv Kita-Plätze in Bonn und im Rhein-Sieg-Kreis. Vereinbarkeit von Familie und Beruf ist uns besonders wichtig.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <a href="https://medizinundtherapie.de" class="site-footer__logo" aria-label="Medizin & Therapie – Zur Startseite">
          <picture>
            ...
            <img
              ...
              alt="GMKB Medizin & Therapie – Ergotherapie Karriere Köln/Bonn"
