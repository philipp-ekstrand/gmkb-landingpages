<?php
/**
 * Template Name: Karriere – Logopädie
 *
 * Custom Page Template fuer die Logopaedie-Landingpage auf karriere.medizinundtherapie.de.
...
<head>
  ...
  <!-- SEO Meta Tags -->
  <title>Logopäde (m/w/d) – Stellenangebote Logopädie Köln/Bonn | GMKB Karriere</title>
  <meta name="description" content="Logopäde gesucht! Logopädie Stellenangebote Köln/Bonn: unbefristet, tarifliches Gehalt, 31 Tage Urlaub, Logopädie Weiterbildungsmöglichkeiten. Jetzt in 60 Sekunden bewerben bei der GMKB. Auch Logopädin Quereinstieg und Jobsuche Logopädie willkommen.">
  <!-- TODO: Nach Live-Schaltung wieder auf "index, follow" setzen -->
  <meta name="robots" content="noindex, nofollow">
  <link rel="canonical" href="https://karriere.medizinundtherapie.de/logopaede-logopaedin/">

  <!-- Open Graph -->
  <meta property="og:type" content="website">
  <meta property="og:title" content="Logopäde (m/w/d) – Stellenangebote Logopädie Köln/Bonn | GMKB Karriere">
  <meta property="og:description" content="Logopädie Jobs Köln: unbefristet, tarifliches Gehalt, Fortbildungen für Logopäden, Kita-Platz. Logopäde Karriere bei der GMKB – bewirb dich in 60 Sekunden.">
  <meta property="og:url" content="https://karriere.medizinundtherapie.de/logopaede-logopaedin/">
  ...
  <!-- Preload Hero Image -->
  <link rel="preload" as="image" type="image/webp" imagesrcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-960w.webp 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-1440w.webp 1440w" imagesizes="(max-width: 900px) 100vw, 55vw">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "JobPosting",
    "title": "Logopäde (m/w/d)",
    "description": "Logopäde gesucht: unbefristete Stelle in Voll- oder Teilzeit im Raum Köln/Bonn. Logopädie Jobs Köln und Bonn, Sprachtherapie bei Kindern und Jugendlichen. Tarifliches Gehalt (ca. 48.800 – 57.300 EUR Jahresbrutto), 31 Tage Urlaub, Fortbildungen für Logopäden, Logopädie Weiterbildungsmöglichkeiten, Kita-Platz-Vermittlung. Auch Logopädin Quereinstieg möglich.",
    ...
    "jobBenefits": "Unbefristete Anstellung, Tarifliches Gehalt, 31 Tage Urlaub + Heiligabend & Silvester frei, Kita-Platz-Vermittlung, Fortbildungen für Logopäden, Logopädie Weiterbildungsmöglichkeiten, Deutschlandticket, Corporate Benefits, Interdisziplinäre Zusammenarbeit",
    "qualifications": "Staatlich anerkannter Logopäde oder Logopädin",
...
<body>
  ...
  <!-- ============================================================
       [1] HERO SECTION
       ============================================================ -->
  <section class="hero-v2" aria-label="Stellenangebot Logopäde – Logopädie Jobs Köln/Bonn">
    ...
    <div class="container">
     <div class="hero-v2__card">
      <div class="hero-v2__content">
        <p class="hero-v2__eyebrow">Stellenausschreibung Logopädie – GMKB Medizinzentren Köln/Bonn</p>

        <h1 class="hero-v2__title">
          <span class="hero-v2__title-accent">Logopäde / Logopädin gesucht</span>
        </h1>
        ...
        <p class="hero-v2__hook">Du bist auf Jobsuche als Logopäde oder Sprachtherapeut in der Sprachtherapie im Raum Köln/Bonn? Dann bist du bei uns genau richtig.</p>
      ...
      <div class="hero-v2__visual">
        <picture class="hero-v2__single-image">
          <source type="image/webp" srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-960w.webp 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-1440w.webp 1440w" sizes="(max-width: 900px) 100vw, 50vw">
          <img src="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-960w.jpg" srcset="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-960w.jpg 960w, <?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-puppe-1440w.jpg 1440w" sizes="(max-width: 900px) 100vw, 50vw" alt="Logopädin arbeitet mit Kind und Handpuppe im GMKB Medizinzentrum" width="960" height="1440" class="hero-v2__img">
        </picture>
      </div>
     </div>
  ...
  <section class="benefits section" id="benefits" aria-labelledby="benefits-heading">
    <div class="container">
      <div class="benefits__header reveal">
        ...
        <h2 id="benefits-heading">Deine Vorteile als Logopäde in Köln/Bonn bei der GMKB</h2>
        <p class="benefits__intro">Wir bieten dir als Logopäde oder Sprachtherapeut nicht nur einen Job, sondern ein Umfeld, in dem du Kinder ganzheitlich in ihrer Sprachentwicklung fördern kannst.</p>
      </div>
      ...
      <div class="benefits__grid reveal-stagger">
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Unbefristete Stelle bei einem seit über 20 Jahren etablierten gemeinnützigen Träger im Raum Köln/Bonn.</p>
          </div>
        </article>
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Tarifliches Gehalt (ca. 48.800 bis 57.300 EUR Jahresbrutto in Vollzeit inkl. Jahressonderzahlung), zzgl. Kinderzuschlag, VL, Altersvorsorge und Mobilitätszuschuss.</p>
          </div>
        </article>
        ...
        <!-- Card 4: Top Fort- und Weiterbildungen -->
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            <div class="benefit-card__icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <h3 class="benefit-card__title">Weiterbildung Logopädie</h3>
            <p class="benefit-card__text">Kostenübernahme &amp; Freistellung für Pflichtfortbildungen sowie vielfältige Logopädie Weiterbildungsmöglichkeiten in Pädiatrie und Sprachtherapie.</p>
          </div>
        </article>
        ...
        <article class="benefit-card benefit-card--icon-only reveal">
          <div class="benefit-card__body">
            ...
            <p class="benefit-card__text">Eng verzahnt mit Pädiatrie, Ergotherapie und Pädagogik für die ganzheitliche Förderung von Kindern.</p>
          </div>
        </article>
      </div>
      ...
      <div class="benefits__cta reveal">
        <a href="#bewerbung" class="btn btn--flip" data-track="cta-click" data-track-label="benefits-cta">
          <span class="btn__texts">
            <span class="btn__text">Jetzt als Logopäde bewerben</span>
            <span class="btn__text">Jetzt als Logopäde bewerben</span>
          </span>
          <span class="btn__arrows">
            <svg class="btn__arrow-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
  ...
  <section class="aufgaben-profil section" id="aufgaben" aria-labelledby="aufgaben-heading">
    <div class="container">
      <div class="aufgaben__header reveal">
        <span class="benefits__tag">
          <span class="benefits__tag-dot"></span>
          Logopädie Stellenangebote
        </span>
        <h2 id="aufgaben-heading">Aufgaben &amp; Profil</h2>
        <p>Die Logopädie Voraussetzungen und Aufgaben als Logopäde (m/w/d) in unseren Medizinzentren.</p>
      </div>
      ...
      <div class="aufgaben__grid">
        <div class="aufgaben__col reveal">
          ...
          <ul class="aufgaben__list">
            <li>Durchführung logopädischer Diagnostik und Therapie bei Kindern und Jugendlichen</li>
            <li>Behandlung von Sprach-, Sprech-, Stimm- und Schluckstörungen</li>
            <li>Erstellen individueller Therapiepläne und Dokumentation</li>
            <li>Interdisziplinäre Zusammenarbeit mit Kinderärzten, Ergotherapeuten und Pädagogen</li>
          </ul>
        </div>
        <div class="aufgaben__col reveal">
          <h3 class="aufgaben__title">Dein Profil</h3>
          <ul class="aufgaben__list">
            <li>Abgeschlossene Ausbildung als Logopäde oder Logopädin</li>
  ...
  <!-- ============================================================
       [6] TESTIMONIAL SECTION – "Das sagen unsere Mitarbeitenden"
       ============================================================ -->
  <section class="testimonial section" aria-labelledby="testimonial-heading">
    <div class="container">
      <div class="testimonial__header reveal">
        ...
        <h2 id="testimonial-heading">So erleben Logopäden<br>die Arbeit bei der GMKB</h2>
      </div>

      <div class="testimonial__slider" data-interval="4500">
            ...
            <div class="testimonial__card reveal">
              <div class="testimonial__quote-col">
                <figure class="testimonial__quote">
                  ...
                  <blockquote>
                    <p>"...und es macht einfach richtig Spaß zu sehen, wie Kinder Fortschritte machen!"</p>
                  </blockquote>
                  <figcaption>
                    <strong class="testimonial__name">Pina</strong>
                    <span class="testimonial__role">Logopädin</span>
                  </figcaption>
                </figure>
              </div>
              <div class="testimonial__image-col">
                <img src="<?php echo $gmkb_assets; ?>/images/therapeuten/therapeut-tisch-960w.jpg" alt="Pina, Logopädin bei der GMKB" loading="lazy" width="960" height="1440">
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="process section" id="ablauf" aria-labelledby="process-heading">
    <div class="container">
      <div class="process__header reveal">
        ...
        <h2 id="process-heading">Bewerbung in der Logopädie,<br>so einfach geht's</h2>
        <p class="process__intro">Deine Jobsuche Logopädie endet hier – drei einfache Schritte zu deiner neuen Stelle im Raum Köln/Bonn bei der GMKB.</p>
      </div>
  ...
  <section class="form-section section" id="bewerbung" aria-labelledby="form-heading">
    <div class="container container--narrow">
      <div class="form-section__header reveal">
        ...
        <h2 id="form-heading">Jetzt als Logopäde<br>bewerben</h2>
        <p class="form-section__intro">Deine Bewerbung als Logopäde dauert nur 60 Sekunden – kein Lebenslauf nötig. Ob Jobs Logopädie Köln oder Bonn, wir melden uns innerhalb von 72 Stunden.</p>
      </div>

      <div class="form-card reveal">
        <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" class="form" id="bewerbung-form" novalidate enctype="multipart/form-data" data-track="form-submit" data-track-label="bewerbung-logopaedie">

          <input type="hidden" name="action" value="gmkb_bewerbung_logopaedie">
          <input type="hidden" name="csrf_token" value="<?php echo esc_attr( $_SESSION['csrf_token'] ); ?>" id="csrf-token">
          <input type="hidden" name="berufsfeld" value="logopaedin">
          ...
          <div class="form-steps">
            <div class="form-steps__track" id="form-track">
              ...
              <div class="form-steps__step" data-step="0">
                <p class="form-step__question">Hast du eine abgeschlossene Ausbildung als Logopäde oder Logopädin?</p>
              ...
              <div class="form-steps__step" data-step="reject">
                <div class="form-step__reject">
                  ...
                  <p class="form-step__reject-title">Für diese Stelle setzen wir eine abgeschlossene Ausbildung als Logopäde oder Logopädin voraus.</p>
    ...
    <div class="container feature__container">
      <div class="feature__image reveal">
        <picture>
          <source
            type="image/webp"
            srcset="<?php echo $gmkb_assets; ?>/images/logo-therapie-480w.webp 480w, <?php echo $gmkb_assets; ?>/images/logo-therapie-960w.webp 960w, <?php echo $gmkb_assets; ?>/images/logo-therapie-1440w.webp 1440w"
            sizes="(max-width: 900px) 100vw, 50vw"
          >
          <img
            src="<?php echo $gmkb_assets; ?>/images/logo-therapie-960w.jpg"
            srcset="<?php echo $gmkb_assets; ?>/images/logo-therapie-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/logo-therapie-960w.jpg 960w, <?php echo $gmkb_assets; ?>/images/logo-therapie-1440w.jpg 1440w"
            sizes="(max-width: 900px) 100vw, 50vw"
            alt="Logopädin bei der Sprachtherapie mit einem Kind im GMKB Medizinzentrum"
            width="960"
            height="2141"
            loading="lazy"
          >
      ...
      <div class="feature__content reveal">
        ...
        <p>Die GMKB ist ein gemeinnütziger Träger mit über 20 Jahren Erfahrung in der Kinder- und Jugendmedizin. An 12 Standorten in Köln und Bonn arbeiten Logopäden, Kinderärzte, Ergotherapeuten und Pädagogen interdisziplinär zusammen – für eine ganzheitliche Versorgung, die Kindern wirklich hilft.</p>
  ...
  <section class="video section" id="video" aria-labelledby="video-heading">
    <div class="container">
      <div class="video__header reveal">
        ...
        <p class="video__intro">Unsere Logopäden, Sprachtherapeuten und das gesamte Team erzählen, warum die GMKB Medizinzentren in Köln und Bonn ein besonderer Arbeitsplatz sind.</p>
      </div>
        ...
        <div class="video__frame">
          <picture>
            ...
            <img
              ...
              srcset="<?php echo $gmkb_assets; ?>/images/logo-therapie-480w.jpg 480w, <?php echo $gmkb_assets; ?>/images/logo-therapie-960w.jpg 960w, <?php echo $gmkb_assets; ?>/images/logo-therapie-1440w.jpg 1440w"
              sizes="(max-width: 768px) 100vw, 80vw"
              alt="Logopädin arbeitet mit einem Kind am Tisch im GMKB Medizinzentrum"
              width="960"
              height="2141"
              loading="lazy"
              class="video__poster"
      ...
      <section class="cta-banner" aria-label="Jetzt bewerben">
        ...
        <div class="cta-banner__inner">
          ...
          <figure class="cta-banner__figure" aria-hidden="true">
            <img src="<?php echo $gmkb_assets; ?>/images/cta-therapeutin.png" alt="" width="280" height="400" loading="lazy">
          </figure>
        </div>
      </section>
    </div>
  ...
  <section class="form-section section" id="bewerbung-2" aria-labelledby="form-heading-2">
    <div class="container container--narrow">
      <div class="form-section__header reveal">
        ...
        <h2 id="form-heading-2">Jetzt als Logopäde<br>bewerben</h2>
        <p class="form-section__intro">Deine Bewerbung als Logopäde dauert nur 60 Sekunden – kein Lebenslauf nötig. Ob Jobs Logopädie Köln oder Bonn, wir melden uns innerhalb von 72 Stunden.</p>
      </div>

      <div class="form-card reveal">
        <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="POST" class="form" id="bewerbung-form-2" novalidate enctype="multipart/form-data" data-track="form-submit" data-track-label="bewerbung-logopaedie">
  ...
  <section class="faq section" id="faq" aria-labelledby="faq-heading">
    <div class="container">
      <div class="faq__header reveal">
        ...
        <h2 id="faq-heading">Häufige Fragen zur<br>Logopädie Stelle bei der GMKB</h2>
        <p class="faq__intro">Alles Wichtige rund um Jobangebote Logopädie, Logopädie Stellenanzeigen und deine Bewerbung bei der GMKB im Raum Köln/Bonn.</p>
      </div>
      ...
      <div class="faq__grid">
        <div class="faq__col">
          ...
          <div class="faq__item reveal">
            ...
            <div class="faq__answer">
              <p>Absolut! Wir bieten flexible Arbeitszeitmodelle, sowohl Vollzeit als auch Teilzeit. Sprich uns einfach an.</p>
            </div>
          </div>
        ...
        <div class="faq__col">
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Welche Fortbildungen gibt es für Logopäden?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Umfangreiche interne und externe Fortbildungsprogramme mit vielfältigen Logopädie Weiterbildungsmöglichkeiten: von Weiterbildung Logopädie in der Pädiatrie bis zu fachübergreifenden Spezialisierungen in der Sprachtherapie. Kostenübernahme und Freistellung inklusive.</p>
            </div>
          </div>
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Wie ist das Gehalt als Logopäde strukturiert?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Wir vergüten nach Tarif mit regelmäßigen Gehaltsanpassungen. Je nach Erfahrungsstufe liegt das Jahresbruttogehalt derzeit bei ca. 48.800 bis 57.300 EUR in Vollzeit (inkl. Jahressonderzahlung). Dazu kommen Kinderzuschlag, VL, Altersvorsorge, ein Mobilitätszuschuss (z.&thinsp;B. Deutschlandticket) und weitere Corporate Benefits.</p>
            </div>
          </div>
          ...
          <div class="faq__item reveal">
            <button class="faq__question" aria-expanded="false">
              <span>Wo gibt es Stellengesuche Logopäden in der Region?</span>
              <svg class="faq__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 5v14"/><path d="M5 12h14"/></svg>
            </button>
            <div class="faq__answer">
              <p>Logopädie Stellenangebote in der Nähe von Köln und Bonn – unsere Logopädie Stellenangebote Köln umfassen Standorte in Bonn, im Rhein-Sieg-Kreis und im Großraum Köln, gut erreichbar mit öffentlichen Verkehrsmitteln. Aktuell haben wir freie Stellen Logopädie und Logopädie offene Stellen an mehreren Standorten.</p>
            </div>
          </div>
        ...
        <a href="https://medizinundtherapie.de" class="site-footer__logo" aria-label="Medizin & Therapie – Zur Startseite">
          <picture>
            ...
            <img
              ...
              alt="GMKB Medizin & Therapie – Logopädie Karriere Köln/Bonn"
