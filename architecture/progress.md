...
- [ ] Farbpalette definiert (aus GMKB Logo/Corporate Design)
- [ ] Typografie festgelegt (Self-hosted Fonts)
- [ ] Spacing-System definiert
- [ ] Button-Styles definiert
- [ ] Section-Layouts skizziert
